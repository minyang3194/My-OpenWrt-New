...
##补充汉化       
cp -f ./feeds/mypackages/files/udpxy.lua ./feeds/luci/applications/luci-app-udpxy/luasrc/model/cbi
cp -f ./feeds/mypackages/files/mwan3.po ./feeds/luci/applications/luci-app-mwan3/po/zh-cn
...
##替换theme icons
wget -O ./feeds/mypackages/jerrykuku/luci-theme-argon-18.06/htdocs/luci-static/argon/img/bg1.jpg https://github.com/HiJwm/MySettings/raw/main/BackGround/2.jpg
