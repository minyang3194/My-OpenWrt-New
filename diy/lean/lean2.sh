...
##替换theme icons
wget -O ./xiangfeidexiaohuo/luci-theme-argon-18.06/htdocs/luci-static/argon/img/bg1.jpg https://github.com/HiJwm/MySettings/raw/main/BackGround/2.jpg
...
svn export https://github.com/HiJwm/MySettings/trunk/lean/myautocore package/myautocore
##修改概述内容 上述已经修改，本条无意义
